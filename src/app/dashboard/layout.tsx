  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="lg:ml-72 min-h-screen">
        <header className="flex justify-between items-center w-full px-4 md:px-8 lg:px-16 h-20 sticky top-0 z-30 bg-surface-container-low">
          ...
          <div className="flex items-center gap-3 lg:gap-6">
            <div className="relative hidden md:flex items-center bg-surface-container-low rounded-full px-4 py-2 w-48 lg:w-64">
      ...
      <div className="fixed bottom-8 right-8 z-50 hidden md:block">
        <button className="bg-primary text-on-primary w-14 h-14 rounded-full flex items-center justify-center shadow-2xl hover:scale-105 active:scale-95 transition-all">
